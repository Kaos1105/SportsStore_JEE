...
public class ImportDAO extends AbstractDAO {
    ...
    public boolean create(ImportDTO input) throws Exception {
        try {
            ...
            if (ImportDAO.super.ExecuteNonQuery(query, new Object[] { input.getPlacementDate(), input.getWholesalerName(),
                    input.getWholesalerAddress(), input.getWholesalerPhone(), }) == 1)
                return true;
        } catch (Exception e) {
            System.out.println(e.toString());
            // throw e;
